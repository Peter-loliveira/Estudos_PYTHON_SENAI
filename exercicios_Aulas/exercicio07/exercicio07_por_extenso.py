...
unidades = {'0':'zero','1':'Um','2':'Dois','3':'Tres','4':'Quatro','5':'Cinco','6':'Seis','7':'Sete','8':'Oito','9':'Nove'}
def digita():return input('Digite um numero entre -99 e 99: ')
numero = digita()    
while not int(numero) in range(-99, 100):numero = digita()    
else:
    negativo = False
    if numero[0] == '-': negativo = True; numero = numero.replace('-','')
    def retorna():
        if numero in array_dezenas: return array_dezenas.get(numero)
        else:
            if negativo == True: return 'menos {} e {}'.format( dezenas.get(numero[0]), unidades.get(numero[1]) ) if len(numero) == 2 else 'menos {}'.format(unidades[0])
            else: return '{} e {}'.format(  dezenas.get(numero[0]), unidades.get(numero[1]) ) if len(numero) == 2 else '{}'.format(unidades[0])
    print(retorna())

# numero = srt(numero)
# print(type(numero))

# while not numero in range(-99, 99):
#     print('DIGITE NOVAMENTE')
    # try:
    #     x = int(numero)
    # except:
    #     print('Eu falei um NÚMERO, SUA ANTA! Tente Novamente')
    #     numero = digita()
    # else:        
    #     if x < 0 or x > 99:
    #         print('Numero digitado fora dos parametros!')
    #         numero = digita()
    #     else:
    ...
    #         else: 
    #             print('{} e {}\n'.format(dezenas[numero[0]], unidades[numero[1]]) if len(numero) == 2 else '{}'.format(unidades[numero[0]]))
    #         numero = digita()


""" ============================================================================================== """

# Lista de possibilidades para as duas formas abaixo
...
# Jeito com MENOS LINHAS, MAS BURRO, pois usa a lista acima, que não é o ideal.
# try:
#     numero = int(input('Digite Um Numerodo de 1 a 99: '))
# except:
#     print('Ô Jumento, Isso NÃO é um numero')
# else:
#     print('Numero fora do range' if 0 < numero < 100 else  print(lista.get(numero)))

# Jeito com MENOS LINHAS AINDA E IGNORANDO POSSIBILIDADE DE ERRO DO USUÁRIO, MAS AINDA ASSIM BURRO. Também usa a lista acima
# numero_digitado = input('Digite um Numero de 1 a 99: ')
# while  numero_digitado in lista:
#     print('Menos ', lista.get(numero_digitado) if numero_digitado[0] == '-' else  lista.get(numero_digitado))
