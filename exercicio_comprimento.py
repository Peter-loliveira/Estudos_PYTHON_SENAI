...
print('Serão necessário', format(sala_area * 4, ".2f"), 'pisos para preencher a SALA')
print('\n')
...
print('Serão necessário', format(sala_area * 4, ".2f"), 'pisos para preencher o QUARTO')
print('\n')
...
if sala_area * 4 >= 100 or quarto_area * 4 >= 100:
