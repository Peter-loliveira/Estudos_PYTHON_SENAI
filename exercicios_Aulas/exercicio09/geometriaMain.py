...
def main():
    ...
    print('Area: {}'.format(NovoQuadrado.obter_area()))
    print('Perimetro: {}'.format(NovoQuadrado.obter_perimetro()))
    print('Diagonal: {}'.format(NovoQuadrado.obter_diagonal()))
    print('###########################')
    ...
    print('Área: {}'.format(NovoCirculo.obter_area()))
    print('Circunferencia: {}'.format(NovoCirculo.obter_circunferencia()))
    print('##########################')
    print('# CORRIGINDO VALOR DE PI #')
    print('##########################')
    NovoCirculo.alterarPi(pi)
    print('AGORA o circulo tem a área de: {}'.format(NovoCirculo.obter_area()))
    print('AGORA o circulo tem a Circunferencia de: {}'.format(NovoCirculo.obter_circunferencia()))
