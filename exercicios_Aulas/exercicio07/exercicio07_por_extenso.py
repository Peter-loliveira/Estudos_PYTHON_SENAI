...
if numero < 0:
    negativo = True
    numero = numero * -1
print('Menos {}'.format(lista.get(numero)) if negativo else '{}'.format(lista.get(numero)))