...
def main():
    ...
    pessoa1 = Pessoa("Racha Cuca", "111.222.333-44", "02/09/1923")
    ...
    pessoa2 = Pessoa("Alma Negra", "555.666.777-88", "21/02/1929")
    cb2 = ContaBanco(pessoa2, 'P')
    ag1.criar_conta(cb2)
    cb2.depositar(250.00)

    pessoa3 = Pessoa("Tripa Seca", "000.999.999-00", "08/02/1949")
    cb3 = ContaBanco(pessoa3, 'C')
    ag2.criar_conta(cb3)
    cb3.depositar(500.00)

    pessoa4 = Pessoa("Quase Nada", "717.171.717-71", "09/07/1922")
